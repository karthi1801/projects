...
<img src="green.jpg" width="1500" height="1590">
...
$qry="insert into employees (id,fname,lname,gender,address,state,mobno,mail,company,designation,experience,username,password) values ('$id',
