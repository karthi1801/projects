...
<ul>
  ...
  <a href="hrhome.php"><img src="login.png" width="35" height="35">HR home</a></li>

</ul>
<div class ="block">
<table>
<tr>
<th>HR Performence</th>
</tr>
	<tbody>
		...
		<?php
		include_once('connect_db.php');
		$result=mysql_query("select head.id,head.fname,head.lname,head.gender,hr_per.keyskills,hr_per.feedback,hr_per.rating
		from head,hr_per where head.id=hr_per.h_id and head.id='$id'");
        if($result>0){
